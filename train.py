...
def main():
    ...
    model = CaptionGenerator(word_to_idx, dim_feature=[196, 512], dim_embed=300,
    ...
    solver = CaptioningSolver(model, data, val_data, n_epochs=20, batch_size=128, update_rule='adam',
                                    ...
                                    pretrained_model=None, model_path='model/lstm2/', test_model='model/lstm/model-10',
                                     print_bleu=True, log_path='log2/')
